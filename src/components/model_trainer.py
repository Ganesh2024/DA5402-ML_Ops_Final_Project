...
class ModelTrainer:
    ...
    def get_model_object_and_report(self, train: np.array, test: np.array) -> Tuple[object, object]:
        try:
            ...
            return model, metric_artifact, accuracy
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        ...
        try:
            ...
            # ── MLflow tracking ──────────────────────────────────────────────
            mlflow.set_experiment("VehicleInsurance-RandomForest")
            ...
            with mlflow.start_run(run_name="RandomForest_Training"):
                ...
                # Train
                trained_model, metric_artifact, accuracy = self.get_model_object_and_report(
                ...
                # Log model
                mlflow.sklearn.log_model(trained_model, "RandomForestModel")

                logging.info(f"MLflow Run logged — accuracy: {accuracy:.4f}, f1: {metric_artifact.f1_score:.4f}")
            # ── end MLflow ───────────────────────────────────────────────────
